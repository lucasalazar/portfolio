<template>
  <div class="h-screen w-screen bg-gray-100 flex items-center">
    ...
    >
      <div class="max-w-md">
        <div class="text-5xl font-bold animate-bounce">404</div>

        <p class="text-xl md:text-2xl font-bold leading-normal montserrat">
          Essa página não foi encontrada.
        </p>

        <p class="mb-8 font-normal robotomono">
          Mas não se preocupe, você pode navegar no site pela homepage.
        </p>
      ...
      <div class="max-w-xl">
        ...
        >
          <defs>
            <linearGradient
              id="fb7ae7e0-1793-4d3b-a6c6-7b51ed07a232-50"
              x1="86.9"
              y1="457.32"
              x2="402.8"
              y2="457.32"
            ...
            <linearGradient
              id="26387a05-323e-43c3-b271-53af00551daf-51"
              x1="3013.29"
              y1="358.28"
              x2="3255.1"
              y2="358.28"
              gradientTransform="matrix(-1, 0, 0, 1, 3342, 0)"
              xlink:href="#fb7ae7e0-1793-4d3b-a6c6-7b51ed07a232-50"
            />
          </defs>
          <ellipse
            cx="530.99"
          ...
          <path
            ...
            transform="translate(-83.88 -33.68)"
            fill="url(#fb7ae7e0-1793-4d3b-a6c6-7b51ed07a232-50)"
          />
          <path
          ...
          <path
            ...
            transform="translate(-83.88 -33.68)"
            fill="url(#26387a05-323e-43c3-b271-53af00551daf-51)"
          />
          <rect
            x="284.7"
            y="262.55"
